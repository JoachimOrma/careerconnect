...
def applicants(id):
    ...
    if request.method == 'POST':
        ...
        if status and feedback:
            ...
            msg = Feedback(content=feedback, feedback_employerid=empid.employer_id, feedback_jobseekerid=application_deets.application_jobseekerid, feedback_applicationid=application_deets.application_id)
            db.session.add(msg)
